...
export default function SearchBar() {
  ...
  return (
    <form
      ...
      className="relative flex items-center w-fit focus-within:w-fit border-2 rounded-full border-gray-300/60 bg-white shadow-md transition-all duration-500 ease-in-out"
    >
