      ...
      <Modal>
        ...
        <ModalBody>
          <ModalContent className=" bg-[url('/images/tactile_noise.png')] bg-repeat bg-x-0 bg-y-0 h-screen from-red-500 via-red-900/90 to-neutral-red/70 backdrop-blur-xl border border-white/10 shadow-2xl">
            {/* Decorative circles */}
            <div className="absolute -z-10 top-0 left-0 w-32 h-32 bg-pink-500/20 rounded-full blur-3xl"></div>
            <div className="absolute -z-10 bottom-0 right-0 w-32 h-32 bg-blue-500/20 rounded-full blur-3xl"></div>
