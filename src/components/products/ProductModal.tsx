    ...
    <div className="flex items-center justify-between">
      <Modal>
        ...
        <ModalBody>
          ...
          <ModalContent className=" bg-pattern bg-32 bg-0-0 bg-[#797979] bg-repeat h-screen  border border-white/10 shadow-2xl" >
        
            <div className="relative z-10">
              <h4 className="text-lg  md:text-2xl text-white font-bold text-center mb-8 flex items-center justify-between gap-3">
                <span>{product.name}</span>
                <span className="px-2 py-1 rounded-full text-sm bg-white/10 backdrop-blur-sm border border-white/20">
                  {product.category}
                </span>
              </h4>
              {/* div images */}
              <div className="flex justify-center items-center mb-8">
                {product.images.map((image, idx) => (
                  <motion.div
                    ...
                    className="rounded-2xl -mr-4 p-1 bg-gradient-to-br from-white/20 to-white/10 backdrop-blur-sm border border-white/20"
                  >
                    <Image
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="flex flex-col gap-4">
                    {product.whatsappLink && (
                      <Button
                        variant="outline"
                        className="  bg-white/10 border-white/20 hover:bg-white/20 text-white w-1/2"
                      >
                        <a
                    ...
                    {product.localisation && (
                      ...
                      >
                        ...
                        >
                          ...
                          <span className="hidden lg:flex">Google Maps</span>
                        </a>
                      </Button>
                    )}
                  </div>
              ...
              <Button className="w-full  text-white rounded-xl py-3 flex items-center justify-center gap-2 border-none">
                Ajouter
