...
import { Heart, Share2, ShoppingCart, Trash2, ImageIcon } from "lucide-react";
...
export function WishCard({ 
  ...
  return (
    ...
    >
      <Card className="relative w-52 h-52 bg-gray-300 rounded-3xl overflow-hidden shadow-lg border-2 border-white transition-all duration-1000 ease-in-out group ">
        <CardHeader>
          <div className="aspect-square overflow-hidden rounded-lg relative flex items-center justify-center">
        ...
        <CardContent className="p-4 group-hover:translate-y-12 space-y-2">
