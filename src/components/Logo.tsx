    ...
    return (
        ...
        >
            ...
            >
                ...
                <span className={`${isVisible?  "opacity-100 bg-[#181818] " :" bg-[#18181800] opacity-5 "} absolute inset-0 bg-[#181818] dark:bg-transparent -z-10 rounded-[10px] pointer-events-none transition-all duration-300 group-hover:rotate-[35deg] group-hover:origin-bottom `} />
            </button>
        </Link>
    )
}
