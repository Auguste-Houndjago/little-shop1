    ...
    <div className="w-full  ">
      ...
      >
            ...
            <CarouselItem key={index} className="relative group ">
              <div className=" relative aspect-[2.5/1] md:h-full h-[300px]  rounded-md w-full overflow-hidden">
                <Image
                  ...
                  className=" opacity-0  object-cover animate-gentle-zoom transform transition-transform transition-700 scale-100 group-hover:scale-105"
                  priority={index === 0}
                />
        ...
        <div className="absolute w-full top-1/2 flex -translate-y-1/2 justify-between ">
          ...
          <CarouselNext className="relative right-1 h-6 w-6 md:h-12 md:w-12 rounded-full border-2 opacity-50 hover:opacity-100 transition-opacity" />
        </div>
